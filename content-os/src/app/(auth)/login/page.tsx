          ...
          <div style={{ animation: "fadeUp 0.6s ease-out" }}>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-[14px] text-[#71717A] mt-2">
                {mode === "signup" ? "Sign up to launch your content command center" : "Sign in to your content command center"}
              </p>
            </div>
            ...
            <div className="rounded-2xl p-6" style={{ background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.06)", backdropFilter: "blur(12px)", animation: "glow-pulse 3s ease-in-out infinite" }}>
              ...
              >
                ...
                <span className="relative">{mode === "signup" ? "Sign up with Google" : "Continue with Google"}</span>
